...
let print_position ppf pos =
    match pos with
    | PosPoint lpos ->
        fprintf ppf "file \"%s\", line %d, character %d: " lpos.FileName lpos.Line lpos.Column
